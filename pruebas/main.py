...
from model import Generator, Discriminator, GeneratorCNN,GeneratorCNNOrdinal
from prueba_train_ordinal import train
from pruebas.pretrain import pretrain_generator_as_autoencoder
import os
